...
def HomePage():
    ...
    def contactus():
        ...
        homebtn = Button(cntct, text="HomePage", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                         borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                         activeforeground="#141E61", command=HomePage)
        homebtn.place(x=784, y=40)
        contactusbtn = Button(cntct, text="About Project", font=("Agency FB", 16, "bold"), width=12, relief=FLAT, bd=0,
                              borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                              activeforeground="#141E61", command=aboutus)
        contactusbtn.place(x=909, y=40)
        exitbtn = Button(cntct, text="Exit", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                         borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                         activeforeground="#141E61", command=exit)
    ...
    def aboutus():
        ...
        homebtn = Button(about, text="HomePage", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                         borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                         activeforeground="#141E61", command=HomePage)
        homebtn.place(x=800, y=40)
        contactusbtn = Button(about, text="About Us", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                              borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                              activeforeground="#141E61", command=contactus)
        contactusbtn.place(x=925, y=40)
        exitbtn = Button(about, text="Exit", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                         borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                         activeforeground="#141E61", command=exit)
        exitbtn.place(x=1050, y=40)
    ...
    def VideoMode():
        ...
        homebtn = Button(predict_stream, text="HomePage", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                         borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                         activeforeground="#141E61", command=HomePage)
        homebtn.place(x=800, y=40)
        contactusbtn = Button(predict_stream, text="About Us", font=("Agency FB", 16, "bold"), width=10, relief=FLAT,
                              bd=0, borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                              activeforeground="#141E61", command=contactus)
        contactusbtn.place(x=925, y=40)
        exitbtn = Button(predict_stream, text="Exit", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                         borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                         activeforeground="#141E61", command=exit)
        exitbtn.place(x=1050, y=40)
        ...
        add_string = Button(predict_stream, text="ADD", font=("Agency FB", 16, "bold"), width=12, relief=FLAT, bd=0,
                            borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                            activeforeground="#141E61", command=add_into_string)
        add_string.place(x=600, y=600)
        remove_string = Button(predict_stream, text="REMOVE", font=("Agency FB", 16, "bold"), width=10, relief=FLAT,
                               bd=0, borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                               activeforeground="#141E61", command=remove_from_string)
        remove_string.place(x=850, y=600)

        predict_stream.mainloop()

    ''' MENU BAR '''
    aboutusbtn = Button(window, text="About Project", font=("Agency FB", 16, "bold"), width=12, relief=FLAT, bd=0,
                        borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                        activeforeground="#141E61", command=aboutus)
    aboutusbtn.place(x=784, y=40)
    contactusbtn = Button(window, text="About Us", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0,
                          borderwidth='0', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                          activeforeground="#141E61", command=contactus)
    contactusbtn.place(x=925, y=40)
    exitbtn = Button(window, text="Exit", font=("Agency FB", 16, "bold"), width=10, relief=FLAT, bd=0, borderwidth='0',
                     bg="#787A91", fg="#0F044C", activebackground="#EEEEEE", activeforeground="#141E61", command=exit)
    exitbtn.place(x=1050, y=40)

    livestream = Button(window, text="LIVE STREAM", font=("Arial Narrow", 18, "bold"), width=20, relief=FLAT, bd=1,
                        borderwidth='1', bg="#787A91", fg="#0F044C", activebackground="#EEEEEE",
                        activeforeground="#141E61", command=VideoMode)
